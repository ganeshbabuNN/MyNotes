...
@ManagedBean(name="mbdemoBean")
@SessionScoped
public class Mbdemobean {
	private String name;
	private String email;
	@ManagedProperty(value="9999")
	private String phone;
	@ManagedProperty(value="10-10-10")
	private String dob;
	@ManagedProperty(value="#{courseBean.cost}")
	private double fee;
	@ManagedProperty(value="#{dataBean.courses}")
	private List<String> courses;
	@ManagedProperty(value="#{dataBean.refs}")
