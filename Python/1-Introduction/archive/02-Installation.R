...
=======================
1)login to https://www.python.org/
2)click on download and python 3.8.5
3)click on the install icon and Click next next button
4)Write a Code.
...
#Installation multiple version of Python using UV tool
======================================================
...
For Setuppting up pycharm
=========================
https://www.jetbrains.com/pycharm/


For setup in Jupyter using online version & offline version
===========================================================
https://notebooks.gesis.org/
https://colab.research.google.com/notebooks - google clob


for setup using Anaconda
========================
...
https://codescracker.com/python/program/index.htm  #lot of examples
