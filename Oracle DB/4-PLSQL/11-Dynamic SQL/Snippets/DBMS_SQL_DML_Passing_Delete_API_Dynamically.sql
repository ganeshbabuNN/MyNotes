---calling the API procedure dyanmically by passing the variables.
--you are dynamically passing the variable dynamically by passing the value, --where it executes .
DECLARE
    v_dml_string CLOB;  
    -- DBMS_SQL variables
    v_cursor_id NUMBER;
