--Here you trying to passing string which is a string value, , you are setting those Bind variable to the local variable and 
--executing the cursor and printing the output
DECLARE
    v_dml_string CLOB;  
    -- DBMS_SQL variables
    v_cursor_id NUMBER;
