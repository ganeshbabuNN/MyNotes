...
static unsigned int sqlctx = 18970403;
...
{12,4130,178,0,0,
5,0,0,0,0,0,27,21,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,10,0,0,1,10,0,0,
...
/* VARCHAR uid[30]; */ 
struct { unsigned short len; unsigned char arr[30]; } uid;
