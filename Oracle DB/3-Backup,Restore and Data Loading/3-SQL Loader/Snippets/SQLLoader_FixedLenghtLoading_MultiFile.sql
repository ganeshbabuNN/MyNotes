...
--preparing the load file and save it has employeesfixedlengthMulti.ctl
LOAD DATA
...
sqlldr userid=ganesh/<password> control=employeesfixedlengthMulti.ctl
