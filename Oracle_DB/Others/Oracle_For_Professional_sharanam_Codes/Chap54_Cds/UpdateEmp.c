...
static unsigned int sqlctx = 327115;
...
{12,4130,178,0,0,
5,0,0,0,0,0,27,25,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,93,0,4,33,0,0,3,1,0,1,0,2,9,0,0,2,3,0,0,1,3,0,0,
63,0,0,3,53,0,5,43,0,0,2,2,0,1,0,1,3,0,0,1,3,0,0,
86,0,0,4,0,0,30,52,0,0,0,0,0,1,0,
};
...
struct { unsigned short len; unsigned char arr[20]; } pwd;
		...
		int sal;
		/* VARCHAR ename[30]; */ 
struct { unsigned short len; unsigned char arr[30]; } ename;
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "select ((FirstName||' ')||LastName) ,Salary into :b0,:b1  f\
rom Employees where EmployeeNo=:b2";
  ...
  sqlstm.sqptdso = sqlstm.sqtdso;
  sqlcxt((void **)0, &sqlctx, &sqlstm, &sqlfpn);
  if (sqlca.sqlcode == 1403) goto noemp;
  if (sqlca.sqlcode < 0) goto errexit;
}
...

{
  ...
  sqlstm.sqladtp = &sqladt;
  sqlstm.sqltdsp = &sqltds;
  sqlstm.stmt = "update Employees  set Salary=:b0 where EmployeeNo=:b1";
  sqlstm.iters = (unsigned int  )1;
