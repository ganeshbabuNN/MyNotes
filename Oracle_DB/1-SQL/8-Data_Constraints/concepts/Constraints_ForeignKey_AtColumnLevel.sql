...
create table employee (
 employee_Id number(10) PRIMARY KEY,  --- pirmary key
 ...
 mangerno NUMBER(10) REFERENCES employee(employee_id), --- foriegn key of table
 deptno number(10) REFERENCES departments    --- foriegn key
 );
